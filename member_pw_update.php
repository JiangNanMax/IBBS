...
$template['title'] = '密码修改';
$template['css'] = array('css/public.css', 'css/index.css', 'css/register.css');
...
<div id="register" class="auto">
    <h2>修改密码</h2>
    <form method="post">
        <label>旧密码：<input type="password" name="old_pw"><span class="note">&nbsp;- 请输入原来的密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label>
