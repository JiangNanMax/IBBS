...
<?php include 'inc/header.inc.php'; ?>
    ...
    <div id="hot" class="auto">
        ...
        <ul class="newlist">
            <li><a href="#">IBBS</a><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;本站定位为编程论坛网站，主要功能即在相应的主题模块下进行发帖、评论以及回复，进行与编程相关的交流讨论。其中，管理员们有权删除不符合社会主义核心价值观的内容。另外，本站还有动态页面和资源页面。动态页面会及时推送一些技术方面的最新动态，
                通过url链接进行内容跳转。而资源页面则提供免费的编程资源下载。So, Welcome! Enjoy!</a></li>
        </ul>
        <!-- 清除左右漂浮 -->
